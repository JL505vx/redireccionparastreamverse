...
SECRET_KEY = 'django-insecure-%h)++nyk7=1va)y&u1eu+n#w7tg$psed*wzga!pb(qv!@c)l+f'
...
DATABASES = {
	...
	'NAME': 'postgres',
        'USER': 'postgres.uqblokgbgkjtemshvnkj',
        'PASSWORD': 'Gigly852zxc',
